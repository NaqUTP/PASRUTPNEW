...
<head>
  ...
  <title>Chemistry I Workbook</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Chemistry I Workbook</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="chemistry-I-workbook.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>BOOKS/Academic</span>
      <h1>Chemistry I Workbook</h1>
      ...
      <p>
        (including notes) for foundation students<br/> <br/>
        RTS : tak pernah guna pun sebelum ni masa beli<br/> <br/>
        Price  : one set (all 3) for RM7
      </p>
    </div>
  </div>
</section>
