...
<head>
  ...
  <title>Baseball Carhartt Cap</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Baseball Carhartt Cap</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="baseball-cap-carhartt-1.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Cap</span>
      <h1>Baseball Carhartt Cap</h1>
      <div class="price">RM25.00 (Negotiable)</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: Freesize</option>
          </select>
        </div>
      </form>
