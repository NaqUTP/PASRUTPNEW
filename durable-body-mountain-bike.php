...
<head>
  ...
  <title>Durable Body Mountain Bike</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Durable Body Mountain Bike</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="durable-body-mountain-bike.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Bike</span>
      <h1>Durable Body Mountain Bike</h1>
      <div class="price">RM520.00 (Negotiable)</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: 26"</option>
          </select>
        </div>
      </form>
      <h3>Product Detail</h3>
      <p>
        - Just bought it last sem <br/> <br/>
        - RTS : Rarely used<br/> <br/>
        - NP : RM620<br/> <br/>
        - Free bicycle lock and red back lamp
      </p>
    </div>
  </div>
</section>
