...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Flowers</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="flowers.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PREORDER/Flowers</span>
      <h1>Flowers</h1>
      <div class="price">From RM6.00</div>
      <form>
        <div>
          <select>
      ...
      <form class="form">
        ...
        <a href="https://web.telegram.org/a/#6477891869" class="addCart">Order Now!</a>
      </form>
      <h3>Product Detail</h3>
      <p>
        🌹🌹🌹 hiii, we're now selling our flowers at v2 foyer. <br/> <br/>
        come and get yours now or we can deliver it for free to your village. 🌹🌹🌹<br/> <br/>
        - kekwa RM7<br/> <br/>
        - rose RM6<br/> <br/>
        - daisy RM6
      </p>
