...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Delivery Service</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="delivery-service.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      ...
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: All sizes</option>
          </select>
        </div>
      </form>
      <form class="form">
        <input type="text" placeholder="1" readonly/>
        <a href="https://wa.me/message/MTLAKBQEC33KF1" class="addCart">BOOK NOW!</a>
      </form>
    </div>
  </div>
</section>
