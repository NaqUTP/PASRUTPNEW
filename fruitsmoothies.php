...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Fruit Smoothies</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="fruit-smoothies.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>Food/Drinks</span>
      <h1>Fruit Smoothies</h1>
      <div class="price">RM6.00</div>

      <form class="form">
        <a href="https://forms.gle/tdcuXUbLGTx5Mhhu8  " class="addCart">Order Now</a>
      </form>
      <h3>Product Detail</h3>
      <p>
        - We're now open Pre-Order for Fexes 4.0 Fruit Smoothies by Sip & Slurp!<br/> <br/>
        - 💢 Dive into a fruity delight at Sip & Slurp this Wednesday, February 28th!<br/> <br/>
        - 🍓 Elevate your experience with customizable toppings: whipped cream, fresh fruits, sprinkles, and marshmallows. <br/> <br/>
        - ❤‍🔥 Don't miss out on the chance to tantalize your taste buds with a burst of fruity freshness! <br/> <br/>
        - Follow us on Instagram and TikTok for more updates 🫰🏻<br/> <br/>
        <a href="https://www.instagram.com/sipnslurp.fexes/"><span><i class='bx bxl-instagram' ></i> @sipnslurp.fexes</span></a><br/>
        <a href="https://www.tiktok.com/@sipnslurp.fexes"><span><i class='bx bxl-tiktok' ></i> @sipnslurp.fexes</span></a>
      </p>
    </div>
  </div>
</section>
