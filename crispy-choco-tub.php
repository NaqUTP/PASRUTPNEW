...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Crispy Choco Tub</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    ...
    <div class="right">
      <span>Food</span>
      <h1>Crispy Choco Tub</h1>
      <div class="price">RM15.00</div>

      <form class="form">
        <a href="https://forms.gle/eVVVNjgjiD4aMLZK8" class="addCart">Order Now</a>
      </form>
      <h3>Product Detail</h3>
      <p>
        🧭LIMITED STOCK!!!!🧭<br/>
        A long-awaited product has finally landed on UTP. Take your chance to grab this opportunity before your luck runs out.<br/> <br/>

        Serve with a combination of crispy cookies with a generous sweet sauce.😋😋<br/> <br/>

        Come up with:<br/> <br/>

        🍫Choco Krisp : RM 15<br/>
        🌈 Mini Rainbow Crunch : RM 15<br/>
        🍫 Choco Ball : RM 15<br/>
        🍫 Choco Crunch : RM 15<br/>
        🍓 Strawberry : RM 15<br/> <br/>

        🦽 Delivery: RM 1 (for all villages)<br/>
        We only accept COD (cash on delivery) 🚕🚕.
      </p>
    </div>
  </div>
</section>
