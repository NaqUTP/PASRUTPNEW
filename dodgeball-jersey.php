...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Dodgeball Jersey</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="dodgeball-jersey.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PREORDER/Shirts</span>
      <h1>Flannel</h1>
      <div class="price">From RM43.00</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: XS - 8XL</option>
          </select>
        </div>
      </form>
      <form class="form">
        <input type="text" placeholder="1" readonly/>
        <a href="https://forms.gle/D1dMezTRbZXPNYCeA" class="addCart">Order Now!</a>
      </form>
      <h3>Product Detail</h3>
      <p>
        Get ready to dominate the court with our stylish and high-performance new dodgeball jersey design!<br/> <br/>

        Here's some details about the jersey:<br/>
        💥 *New design and color palette*<br/>
        💥 *More affordable, but same high quality standards*<br/> <br/>


        🤾🏼‍♂️Sizes available: *XS* to *8XL* (unisex)<br/> <br/>
        Price:<br/>
        💰*RM43 (UTP STUDENT)*‼️‼️ - price may vary due to jersey size
      </p>
    </div>
  </div>
</section>
