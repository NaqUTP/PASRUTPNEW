...
<head>
  ...
  <title>Coolermaster MA612 Stealth ARGB CPU Cooler</title>
</head>
...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Coolermaster MA612 Stealth ARGB CPU Cooler</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="Coolermaster-MA612-Stealth-ARGB-cpu-cooler.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Tech</span>
      <h1>Coolermaster MA612 Stealth ARGB CPU Cooler</h1>
      <div class="price">RM250.00-RM300.00 (Negotiable)</div>
      <form>
        <div>
          <select>
      ...
      <p>
        - Condition : Brand new beli hujung bulan satu cuma kotak dh bukak. Warranty ada lagi x silap sbb x kacau pun <br/> <br/>
        - Reason : Beli pastu tau2 X jumpa AM5 mounting kit so terpaksa beli cooler baru and nk letgo yg ni<br/> <br/>
        - Price : Market price 250-300 tp can nego selagi bole jual<br/> <br/> <br/>

        WARNING: AM5 mounting kit not included
      </p>
    </div>
  </div>
</section>
