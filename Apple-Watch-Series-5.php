...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Apple Watch Series 5</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="Apple-Watch-Series-5.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>PRELOVED/Watch</span>
      <h1>Apple Watch Series 5</h1>
      <div class="price">RM650.00 (Negotiable)</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Size: 44 MM</option>
          </select>
        </div>
      </form>
      <form class="form">
