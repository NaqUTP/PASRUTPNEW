...
<section class="breadcrumb">
  <div class="breadcrumb__list flex container">
    ...
    <span class="breadcrumb__link"> > </span>
    <span class="breadcrumb__link">Beelisimo.s</span>
  </div>
</section>
...
<section class="section product-detail">
  <div class="details container">
    <div class="left image-container">
      <div class="main">
        <img src="Beelisimo.s.jpeg" id="zoom" alt="" />
      </div>
    </div>
    <div class="right">
      <span>SERVICES/Hygiene</span>
      <h1>Beelisimo.s</h1>
      <div class="price">N/A</div>
      <form>
        <div>
          <select>
            <option value="Select Size" selected>Type: All types</option>
          </select>
        </div>
      </form>
      <form class="form">
        <input type="text" placeholder="1" readonly/>
        <a href="https://bit.ly/beelisimo-s" class="addCart">BOOK NOW!</a>
      </form>
      <h3>Product Detail</h3>
      <p>
        Get your nails looking fabulous with Beelisimo.s! <br/> <br/>
        💅✨ Our prices are very student-friendly!<br/> <br/>
        Let's get those nails shine!!! 💕
      </p>
    </div>
  </div>
</section>
